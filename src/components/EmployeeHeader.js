...
const EmployeeHeader = ({ setShowSidebar, showSidebar }) => {

    return (
        <Container fluid className="site-header site-header-employee ">
            <Row className="center-align">
                <Col md={10} sm={9} xs={8} className='pb-2'>
                ...
                <Col md={2} sm={3} xs={4} className="justify-content-end align-items-center d-flex">

                    <Col className='h3 d-block d-xl-none' xs={4}>
                        <p onClick={() => { setShowSidebar(!showSidebar) }} className='cursor-pointer'>
